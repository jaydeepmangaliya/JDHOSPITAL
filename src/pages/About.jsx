    ...
    <div>
      <div className="text-center  text-2xl pt-10 text-gray-500">
        ...
        <div className="flex flex-col md:flex-row mb-20">
          <div className="border px-10 md:px-16 py-8 sm:py-16 flex-col gap-5 text-[15px] hover:bg-[#5f6FFF] hover:text-white transition-all text-gray-600 cursor-pointer ">
            <b>EFFICIENCY:</b>
            <p>
