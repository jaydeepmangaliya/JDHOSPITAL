  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6FFF] rounded-lg px-6 md:px-10 lg:px-20'>
       ...
       <div className='flex flex-col md:flex-row itmes-center gap-3 text-white text-sm font-light'> 
        ...
        <p>Simply browse through our extensive list of trusted doctoes, <br className='hidden sm:block' /> scedule your appointment hassle-free.</p>
       </div>
       <a  href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md;m-0 hover:scale-105 transitiom-all duration-300'> 
